...
# simplified code (compared to the main.py) :D, a bit buggy because I didn't put it into a class, but does the job!
...
while True:
    ...
    # QUESTION 1 - MOOD
    question_1 = ctk.CTkInputDialog(title="Song Selector", text='''
    ...
    if answer_1.lower() == 'happy':
        question_2 = ctk.CTkInputDialog(title="Song Selector", text='''\nSomeone\'s in a good mood :D Okay, next question:\n
...
Do you want a [1]longer or a [2]shorter one?''', font=("Arial", 12),button_fg_color='#1a1a1a',button_text_color='#1a1a1a')
    ...
    question_3 = ctk.CTkInputDialog(title="Song Selector", text=f'''
